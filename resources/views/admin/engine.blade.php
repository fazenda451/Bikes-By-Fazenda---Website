    ...
    <script>
      function searchEngines() {
        ...
        for (let i = 1; i < rows.length; i++) {
          const engineType = rows[i].getElementsByTagName('td')[0].textContent.toLowerCase();
          if (engineType.includes(input)) {
      ...
      function confirmDelete(event, engineType) {
        event.preventDefault();
        if (confirm(`Tem certeza que deseja excluir o tipo de motor "${engineType}"?`)) {
