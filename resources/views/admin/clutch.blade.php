    ...
    <script>
      function searchClutch() {
        ...
        for (let i = 1; i < rows.length; i++) {
          const clutchType = rows[i].getElementsByTagName('td')[0].textContent.toLowerCase();
          if (clutchType.includes(input)) {
      ...
      function confirmDelete(event, clutchType) {
        event.preventDefault();
        if (confirm(`Tem certeza que deseja excluir o tipo de embreagem "${clutchType}"?`)) {
